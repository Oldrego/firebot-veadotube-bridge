...
export const toggleStateEffect: EffectType<Model> = {
  definition: {
    id: "veadotube:toggle-state",
    name: "Veadotube: Toggle State",
    description: "Toggles a state's existence in a state events node in veadotube",
