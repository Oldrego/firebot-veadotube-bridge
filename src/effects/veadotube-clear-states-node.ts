...
export const clearStatesEffect: EffectType<Model> = {
  definition: {
    id: "veadotube:clear-states",
    name: "Veadotube: Clear States",
    description: "Clears all states from a state events node in veadotube",
