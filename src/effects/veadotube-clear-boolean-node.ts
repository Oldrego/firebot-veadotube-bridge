...
export const clearBooleanEffect: EffectType<Model> = {
  definition: {
    id: "veadotube:clear-boolean",
    name: "Veadotube: Clear Boolean",
    description: "Clears a boolean node's value in veadotube",
  ...
  onTriggerEvent: async ({ effect }) => {
    ...
    instance.clearBoolean(effect.nodeId);
    return { success: true };
  }
};
