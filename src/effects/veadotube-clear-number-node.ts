...
export const clearNumberEffect: EffectType<Model> = {
  definition: {
    id: "veadotube:clear-number",
    name: "Veadotube: Clear Number",
    description: "Clears a number node's value in veadotube",
    icon: "fas fa-hashtag",
  ...
  onTriggerEvent: async ({ effect }) => {
    ...
    instance.clearNumber(effect.nodeId);
    return {success: true};
  }
};
