...
export const pushStateEffect: EffectType<Model> = {
  definition: {
    id: "veadotube:push-state",
    name: "Veadotube: Push State",
    description: "Pushes a state to the top of a state events node in veadotube",
