...
export const popStateEffect: EffectType<Model> = {
  definition: {
    id: "veadotube:pop-state",
    name: "Veadotube: Pop State",
    description: "Pops a state from a state events node in veadotube",
