...
export const setNumberEffect: EffectType<Model> = {
  definition: {
    id: "veadotube:set-number",
    name: "Veadotube: Set Number",
    description: "Set a number node's value and ranges in veadotube",
    icon: "fas fa-hashtag",
