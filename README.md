...
Download the javascript file in the Tags section, go to `Tools > Plugin Manager` within Firebot, and click on `Install From File`. Select the javascript file you downloaded.
