...
Download the javascript file in the Releases section, go to `Tools > Plugin Manager` within Firebot, and click on `Install From File`. Select the javascript file you downloaded.
